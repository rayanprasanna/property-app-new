...
public class MainAdsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //Glide.with(context.getApplicationContext()).load(propertyResponses.get(position).image_path_1).apply(RequestOptions.circleCropTransform()).into(viewHolder.image);
